...
essentially like the "exact" long format. The target format is [[x, y], w] 
(with the assumption that the target is a square, centered at x and y--
NOTE this is different than for the long format)::
